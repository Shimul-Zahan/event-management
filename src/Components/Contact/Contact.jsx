        ...
        <div>
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    ...
                    <button className='btn bg-yellow-500 text-lg px-10 capitalize font-light'>Send</button>
                </div>
            </section>
                ...
                <div className='container mx-auto mb-20 grid grid-cols-1 gap-10 lg:grid-cols-3'>
                    <div className='space-y-4 flex flex-col justify-center items-center'>
                        ...
                        <div className='flex justify-start items-center gap-4'>
                            <img src="/icon/whatsapp.png" alt="" className='h-8 w-8' />
                            <p className='text-xl font-thin text-gray-500'>AlgoWebBot_636</p>
                        </div>
                        <div className='flex justify-start items-center gap-4'>
                            <img src="/icon/viber.png" alt="" className='h-8 w-8' />
                            <p className='text-xl font-thin text-gray-500'>AlgoWebBot_Viber</p>
                        </div>
                        <div className='flex justify-start items-center gap-4'>
                            <img src="/icon/linkedin_3536505.png" alt="" className='h-8 w-8' />
                            <p className='text-xl font-thin text-gray-500'>AlgoWebBot_In_7088</p>
                        </div>
                        <div className='flex justify-start items-center gap-4'>
                            <img src="/icon/facebook.png" alt="" className='h-8 w-8' />
                            <p className='text-xl font-thin text-gray-500'>AlgoWebBot_Tech&Sports</p>
                        </div>
                    </div>
                    <div className='space-y-4 flex items-center flex-col '>
                        <img src="/icon/location.png" alt="" className='h-20 w-20' />
                        <p className='text-lg font-thin text-center'>Jones Hopkins Tower <br />230, Baker Street Road <br />New York, USA</p>
                    </div>
                    <div className='space-y-4 text-end flex flex-col justify-center items-center'>
                        <h1 className='text-2xl font-bold'>Contact</h1>
                        <div className='flex justify-end items-center gap-4'>
                            <p className='text-xl font-thin text-gray-500'>+98 065520</p>
                            <img src="/icon/phone-call_126509.png" alt="" className='h-8 w-8' />
                        </div>
                        <div className='flex justify-end items-center gap-4'>
                            <p className='text-xl font-thin text-gray-500'>+98 065520</p>
                            <img src="/icon/2901594.png" alt="" className='h-8 w-8' />
                        </div>
                        <div className='flex justify-end items-center gap-4'>
                            <p className='text-xl font-thin text-gray-500'>algowebbot@gmai.com</p>
                            <img src="/icon/mail_646094.png" alt="" className='h-8 w-8' />
                        </div>
                    </div>
                </div>
            </div>
